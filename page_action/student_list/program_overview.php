...
<div class="row">
	<div class="col-md-6">
		<table style="width: 100%">
			...
			<tr>
				<td class="program_td">Promotion Name</td>
				<td class="batch_td3"><?php echo "$batch_name"; ?></td>
			</tr>
			<tr>
				<td class="program_td">Module</td>
	...
	<div class="col-md-6">
		<table style="width: 100%">
			<tr>
				...
				<td class="batch_td1">Promotion Name</td>
				<td class="batch_td1">Promotion Day</td>
				<td class="batch_td1">Promotion Time</td>
			</tr>
	<?php 
