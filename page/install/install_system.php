...
<link href="https://fonts.googleapis.com/css2?family=New+Amsterdam&family=Roboto&display=swap" rel="stylesheet">
...
<div class="container" style="padding: 10px;margin-top: 5px;">
                <div class="row register" style="padding: 5px;">
                    <div class="col-md-4 col-sm-12 register-left">
                        ...
                        By <b style="font-size: 16px;"><a href="" style="color: #ffffff">SALIFOU Mouhamadou</a></b>
                        ...
                        <a href=""><input type="submit" name="" value="Github"/></a><br/>
                    </div>
