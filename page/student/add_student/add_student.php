    ...
    <div class="boxz">
      <div class="box_bodyy">
        ...
        <form action="" id="add_student" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6 border">
              ...
              <div class="box_under_body">  
                ...
                $site->form_input("Student Mobile", "student_mobile", "student_mobile", "number", "exclamation-sign", "", "", "no");
                $site->form_input("Father Mobile", "father_mobile", "father_mobile", "number", "exclamation-sign", "", "", "no");
                $site->form_input("Mother Mobile", "mother_mobile", "mother_mobile", "number", "exclamation-sign", "", "", "no");
                $site->form_input("Email", "email", "email", "text", "exclamation-sign", "", "", "no");
                $site->form_input("Birthday", "birthday", "birthday", "date", "exclamation-sign", "", "", "no");
                ?>
            ...
            <div class="col-md-6">
              <div class="form-group upload_body">
                <label class="control-label" for="image"><b>Upload Student Photo</b></label>
                <div class="input-group">
                ...
                <img id="add_thumbnil" class="img_up" src="<?php echo 'upload/student_photo/avatar.png'; ?>" alt="image"/>
              </div> 
              ...
              <div class="box_under_body">
                ...
                <?php 
                  ...
                  $site->form_input("SSC Roll Number", "ssc_rool", "ssc_rool", "number", "exclamation-sign", "", "", "no");
                ...
                <div class='form-group'>
                  <label class='control-label' for='ssc_result'><b>SSC Result</b></label>
                  <div class='input-group'>
                    <span class='input-group-addon'><i class='glyphicon glyphicon-exclamation-sign'></i></span>     
                    <input class='form-control' id='ssc_result' value='' step="0.01" placeholder='Enter SSC Result' type='number' name='ssc_result' />
                  </div>  
          ...
          <center>
            <button class="box_btn" name="insert" type="submit" id="insert_btn"><span class="glyphicon glyphicon-floppy-save"></span> Save Information</button>
          </center>
        </form>
        <!-- end body -->
      </div>
