...
<div class="container" style="width: 100%">
  ...
  <div class="row">
    ...
    <div id="login-box" style="margin-top: 45px;">
        ...
        <div class="footer_login" style="">Developed By: <a href="https://github.com/SALI-546"><font style="font-size: 19px;font-weight: bold;color: #F64343">SALIFOU Mohamed</font></a></div>
    </div>
