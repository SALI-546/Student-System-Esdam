...
<div class="btn-toolbar list-toolbar">
    ...
    <button class="btn btn-primary" data-title="Add promotion"  onclick="get_batch_form('insert')"><i class="fa fa-plus"></i> Add promotion</button>
...
<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%"> 
            ...
            <tr>
              <th></th>
              <th><center>Promotion Name</center></th>
              <th><center>Promotion Start Date</center></th>
              <th><center>Promotion End</center></th>
               <th><center>Promotion Day</center></th>
