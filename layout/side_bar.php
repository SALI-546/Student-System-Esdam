...
?>
        ...
        <img class="img_style"  width="74" hieght="70" src="<?php echo"$photo"; ?>">
                ...
                <?php if($user_permit<8){ ?>
                    ...
                    <li><a href="batch_list.php" class="nav-header"><i class="fa fa-outdent  side_bar_icon"></i> promotion</a></li>

                    <li><a href="program_list.php" class="nav-header"><i class="fa fa-renren side_bar_icon"></i> Program</a></li>

                    <li><a href="subject_list.php" class="nav-header"><i class="fa fa-fw fa-book side_bar_icon"></i> Module</a></li>
                    ...
                    <li><a href="javascript:void(0)" data-target=".notice" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-bullhorn side_bar_icon"></i> Notification<i class="fa fa-collapse"></i></a></li>

                    <li>
                        <ul class="notice nav nav-list collapse">

                            <li><a href="notice_list.php"><span class="fa fa-caret-right"></span>Notification List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="javascript:void(0)" data-target=".sms" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-envelope-o side_bar_icon"></i> MAIL<i class="fa fa-collapse"></i></a></li>
